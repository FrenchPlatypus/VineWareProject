...
public class StoryModeManager : MonoBehaviour
{
    ...
    public IEnumerator CheckMinigameResult()
    {
        ...
        else
        {
            ...
            // Set boss battle every 15 games
            if (infos.level % 15 == 0)
            {
    ...
    public IEnumerator LoadBossMinigame()
    {
        // Instantiate the boss minigame
        GameObject minigameObject = bossMinigame.stages[infos.difficulty];
    ...
    public IEnumerator LoadNewMinigame()
    {
        ...
        int rand = Random.Range(0, minigames.Length);
